...
LFOS = {
 ...
 'slowsine' : (1, 0, 1, 2, 0.2, 0.15, 0.85, 0.0),
 'barsine'  : (1, 0, 1, 3, 0.5, 0.10, 0.90, 0.0),
 'halfsine' : (1, 0, 1, 4, 1.0, 0.20, 0.80, 0.0),
 'qtrsaw'   : (1, 1, 1, 5, 2.0, 0.00, 1.00, 0.0),
 '8thpulse' : (1, 2, 1, 6, 4.0, 0.00, 1.00, 0.0),
 '16thstep' : (1, 1, 1, 7, 8.0, 0.10, 0.95, 0.0),
 'rand1'    : (1, 3, 1, 5, 2.0, 0.05, 0.95, 0.0),
 'smooth'   : (1, 7, 1, 3, 0.4, 0.20, 0.80, 0.0),
 'spread90' : (1, 0, 1, 3, 0.5, 0.10, 0.90, 90.0),
 'spread120': (1, 0, 1, 2, 0.3, 0.05, 0.95, 120.0),
 'liss'     : (1,11, 1, 2, 0.25, 0.10, 0.90, 0.0),
 'spiro'    : (1, 8, 1, 1, 0.15, 0.10, 0.90, 0.0),
 'billiard' : (1,16, 0, 3, 0.12, 0.05, 0.95, 0.0),
 'torus'    : (1,10, 1, 2, 0.2, 0.15, 0.85, 0.0),
 'rose'     : (1,14, 1, 3, 0.3, 0.10, 0.90, 0.0),
}
